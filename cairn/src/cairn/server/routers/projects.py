...
def create_project_fact(project_id: str, body: dict):
    """Create a new fact during active exploration (real-time updates)."""
    from cairn.server.services import next_fact_id
    conn = db.get_conn()
